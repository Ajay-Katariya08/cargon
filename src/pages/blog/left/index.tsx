...
import { authors, blogsPosts, comments, ourTag, overBlog, tags } from "./data";
                        ...
                        <div className="col-lg-4 mb-30">
                            <div className="ca-sidebar-area mr-50">
                                ...
                                <div className="ca-servic-list ca-padding cream-bg-3 br-7 mb-30">
                                    ...
                                    {overBlog.map((post) => (
                                        <h3 className="ca-ser-list-title" key={post}>
                                            <Link
                                ...
                                <div className="ca-servic-list ca-padding cream-bg-3 br-7 mb-30">
                                    ...
                                    {blogsPosts.map((post) => (
                                        <div className="ca-recent-post-section mb-20" key={post.id}>
                                ...
                                <div className="ca-search ca-padding cream-bg-3 br-7 mb-30">
                                    ...
                                    <div className="ca-blg-author">
                                        {authors.map((author) => (
                                            <div className="ca-single-author" key={author.id}>
                                ...
                                <div className="ca-pro-thumb-content ca-service-left-content">
                                    ...
                                    <div className="ca-blg-comt-form pt-32">
                                        ...
                                        {comments.map((comment) => (
                                            <div
                                                className="ca-blg-single-comment cream-bg-3 mb-30"
                                                key={comment.id}
                                            >
